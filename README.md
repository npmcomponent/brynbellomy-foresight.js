*This repository is a mirror of the [component](http://component.io) module [brynbellomy/foresight.js](http://github.com/brynbellomy/foresight.js). It has been modified to work with NPM+Browserify. You can install it using the command `npm install npmcomponent/brynbellomy-foresight.js`. Please do not open issues or send pull requests against this repo. If you have issues with this repo, report it to [npmcomponent](https://github.com/airportyh/npmcomponent).*
## Introduction
...
* Foresight's publicly available speed test file is hosted by Google App Engine, which is a cloud-based service. _(I recommend you use your own hosted image as the default hosted image may experience 503 response errors when it hits the Google App Engine quota.)_
